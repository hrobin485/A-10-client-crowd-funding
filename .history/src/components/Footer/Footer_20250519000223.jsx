  ...
  return (
    <footer className="bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-700 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Flex layout – single column on mobile, row with equal gaps on md+ */}
        <div className="flex flex-col md:flex-row md:flex-wrap md:justify-between gap-10 text-sm text-gray-600 dark:text-gray-300">
          {/* Contact */}
          ...
          {/* Legal */}
          <div className="flex-1 min-w-[220px] flex flex-col gap-4 md:text-right">
