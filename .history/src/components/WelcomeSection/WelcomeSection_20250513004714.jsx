...
const WelcomeSection = () => {
  return (
    <section className="relative overflow-hidden pt-2 sm:px-6 lg:px-8 bg-gradient-to-br from-blue-100 via-white to-blue-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
