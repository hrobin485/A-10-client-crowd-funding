...
const WelcomeSection = () => {
  return (
    <section className="relative overflow-hidden  sm:px-4 lg:pb-3 px-8 bg-gradient-to-br from-blue-100 via-white to-blue-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
