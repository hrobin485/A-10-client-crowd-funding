...
const Testimonials = () => {
  ...
  return (
    <section id="testimonials" className="py-10 bg-gray-100 dark:bg-gray-800 dark:text-gray-100">
      <div className="container mx-auto  "> 
        <h2 className="text-2xl font-bold text-center mb-6">What Our Supporters Say</h2>
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 ">
          {testimonials.map((testimonial, index) => (
            <div key={index} className="bg-white rounded-lg shadow-lg p-6 flex items-center dark:bg-gray-800 dark:text-gray-100">
