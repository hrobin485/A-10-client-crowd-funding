      ...
      <div className={`navbar ${navbarBgColor}`}> {/* Apply the bg color, text color, and rounded class dynamically */}
        <div className="navbar-start">
          ...
          <div className="flex gap-2 items-center">
            <img
              className="h-1/6 w-2/12 rounded-lg"
              src="https://media.istockphoto.com/id/1732008587/vector/winter-clothes-donation-vector-illustration-in-flat-style.jpg?s=612x612&w=0&k=20&c=X9Q0U1cU0CVCgk3Hxb5HTiLcZJShgTMrkts7ixwV4hk="
              alt=""
            />
        ...
        <div className="navbar-end gap-2">
          <h2><FaUser /></h2>
          {/* Add NavLink for the Login button */}
          <NavLink to="/LogIn">
