...
const Navbar = () => {
  ...
  return (
    <nav className="backdrop-blur-md bg-slate-300/60 dark:bg-gray-800/60 text-black dark:text-white rounded-lg p-4 sticky top-0 z-50 w-full">
      <div className="max-w-7xl mx-auto flex flex-wrap lg:flex-nowrap items-center justify-between py-2 gap-y-2 ">
        ...
        {/* desktop nav */}
        <ul className="hidden lg:ml-40 lg:flex lg:items-center  gap-x-6 lg:gap-6">{desktopLinks}</ul>
