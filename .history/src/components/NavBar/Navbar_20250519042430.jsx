...
const Navbar = () => {
  ...
  /* ------------------------------------------------------------------*/
  return (
    <nav className=" backdrop-blur-md bg-slate-300/60 dark:bg-gray-800/60  text-black dark:text-white rounded-lg px-3 sm:px-4
      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between py-2">
        ...
        {/* right‑side controls */}
        <div className="flex items-center gap-2 ml-auto z-40">
          {user ? (
            <>
              <img
        ...
        {/* mobile dropdown */}
        {open && (
          <ul className="absolute left-0 top-full z-30 w-full
                 lg:hidden flex flex-col gap-3
                 max-h-64 overflow-y-auto
                 rounded-b-lg bg-slate-300/90 dark:bg-gray-800/90
                 backdrop-blur-md
