      ...
      <div className={`navbar ${navbarBgColor}`}>
        <div className="navbar-start">
          ...
          <div className="flex gap-2 items-center">
            <img className="h-1/6 w-2/12 rounded-lg" src="https://media.istockphoto.com/id/1732008587/vector/winter-clothes-donation-vector-illustration-in-flat-style.jpg?s=612x612&w=0&k=20&c=X9Q0U1cU0CVCgk3Hxb5HTiLcZJShgTMrkts7ixwV4hk=" alt="Logo" />
        ...
        <div className="navbar-end gap-2">
          {user ? (
            <div className="flex items-center gap-2">
              <img src={user.photoURL || "https://via.placeholder.com/50"} alt="User" className="w-10 h-10 rounded-full" />
