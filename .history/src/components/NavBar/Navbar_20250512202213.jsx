...
const Navbar = () => {
  ...
  const navLinks = (
    <>
      <li><NavLink to="/" className={({ isActive }) => isActive ? "text-blue-600 font-semibold" : "hover:text-blue-500"}>Home</NavLink></li>
      <li><NavLink to="/AllCampaign" className={({ isActive }) => isActive ? "text-blue-600 font-semibold" : "hover:text-blue-500"}>All Campaign</NavLink></li>
      <li><NavLink to="/AddNewCampaign" className={({ isActive }) => isActive ? "text-blue-600 font-semibold" : "hover:text-blue-500"}>Add New Campaign</NavLink></li>
      <li><NavLink to="/MyCampaign" className={({ isActive }) => isActive ? "text-blue-600 font-semibold" : "hover:text-blue-500"}>My Campaign</NavLink></li>
      <li><NavLink to="/MyDonations" className={({ isActive }) => isActive ? "text-blue-600 font-semibold" : "hover:text-blue-500"}>My Donations</NavLink></li>
    </>
  );
