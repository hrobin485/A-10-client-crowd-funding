...
const Navbar = () => {
  ...
  /* ------------------------------------------------------------------*/
  return (
    <nav className="navbar backdrop-blur-md bg-slate-300/60 dark:bg-gray-800/60 text-black dark:text-white rounded-lg px-4 sticky top-0 z-50">
      <div className="max-w-7xl mx-auto flex flex-wrap items-center justify-between py-2 gap-y-2">
        ...
        {/* mobile dropdown */}
        {open && (
          <ul className="absolute left-0 top-full w-full bg-slate-300/60 dark:bg-gray-800/60
                 flex flex-col gap-3 pt-2 pb-4 lg:hidden">
            {mobileLinks}
          </ul>
        )}
