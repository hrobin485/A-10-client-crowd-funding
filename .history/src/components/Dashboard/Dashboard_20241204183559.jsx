...
const Dashboard = () => {
  ...
  const [password, setPassword] = useState(null); // State to store password
  ...
  useEffect(() => {
    ...
    if (storedPassword) {
      setPassword(storedPassword); // Set password from localStorage
    } else {
      ...
      <div className="bg-white p-8 rounded shadow-md w-full max-w-md">
        ...
        {user ? (
          <div className="flex flex-col items-center">
            ...
            {/* Displaying password (Not recommended, shown here for example purposes) */}
            <p className="text-sm text-gray-600 mt-2">Password: {password}</p>
