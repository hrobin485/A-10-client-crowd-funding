  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-gray-100 dark:bg-gray-900">
      ...
      <aside
        ...
        } md:block w-full md:w-64 bg-white dark:bg-gray-800 p-6 shadow-lg z-10 md:relative fixed md:static top-0 left-0 h-full overflow-y-auto transition-all mt-5`}
      >
