...
const CampaignDetail = () => {
  ...
  const handleDonate = async () => {
    ...
    try {
      const response = await fetch(
        "https://crowdfunding-store-server.vercel.app/donated", // ✅ updated to match your server route
        {
          method: "POST",
    ...
    <div className="container mx-auto p-6 max-w-full my-5 rounded-lg">
      <div className="bg-white dark:bg-gray-700 rounded-lg shadow-xl p-6 lg:p-10">
        ...
        <button
          ...
          className={`w-full py-3 mt-6 rounded-md text-lg font-bold ${
            isDeadlineOver
        ...
        >
          {isDeadlineOver
            ? "Deadline is finished, cannot donate"
            : "Donate Now"}
        </button>
      </div>
    </div>
