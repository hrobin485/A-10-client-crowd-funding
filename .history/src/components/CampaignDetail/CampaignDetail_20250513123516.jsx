...
const CampaignDetail = () => {
  ...
  const handleDonate = async () => {
    ...
    try {
      const response = await fetch(
        "https://crowdfunding-store-server.vercel.app/donate",
        {
          method: "POST",
  ...
  return (
    <div className="container mx-auto p-6 max-w-full bg-gradient-to-r from-blue-100 via-purple-100 to-pink-100">
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl p-6 lg:p-10">
        {/* Image section */}
        {image && (
          <img
            src={image}
