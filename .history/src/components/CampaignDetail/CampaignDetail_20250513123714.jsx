...
const CampaignDetail = () => {
  ...
  if (!campaign) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[200px] dark:text-gray-100 dark:bg-gray-700">
  ...
  return (
    <div className="container mx-auto p-6 max-w-full bg-gradient-to-r from-blue-100 via-purple-100 to-pink-100 dark:bg-gray-700">
      <div className="bg-white dark:bg-gray-600 rounded-lg shadow-xl p-6 lg:p-10">
        {/* Image section */}
        {image && (
          <img
            src={image}
