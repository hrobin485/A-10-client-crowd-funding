...
export default function Banner() {
  ...
  return (
    <section className="relative mt-4 rounded-xl bg-gradient-to-br from-blue-100 via-white to-blue-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
        ...
        <div className="relative h-72 md:h-96 lg:h-[28rem] rounded-xl overflow-hidden shadow-lg">
          {slides.map(({ id, image }, i) => (
            <img
              ...
              src={image}
              alt=""
              className={`absolute inset-0 w-full h-full object-cover object-center transition-opacity duration-300 ${i === index ? "opacity-100" : "opacity-0"
                }`}
            />
          ))}
