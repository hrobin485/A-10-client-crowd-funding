...
const WhyChooseCrowdcube = () => {
  ...
  return (
    <section className="py-14 rounded-lg bg-white dark:bg-gray-900">
      <div className="max-w-6xl mx-auto px-4">
        <h2 className="text-3xl font-bold text-center text-gray-800 dark:text-white mb-4">
          Why Choose <span className="text-blue-600">Crowdfunding</span>?
        </h2>
        <p className="text-center text-gray-600 dark:text-gray-300 mb-10 max-w-2xl mx-auto">
          We’re more than just a fundraising platform. Discover the unique advantages of raising funds through Crowdfunding.
        </p>
