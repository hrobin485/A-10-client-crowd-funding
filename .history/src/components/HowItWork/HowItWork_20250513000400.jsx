    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 dark:text-gray-100">
      ...
      <div className="flex items-center">
        ...
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-300">Set up your project, tell your story, and set a fundraising goal.</p>
        </div>
      </div>
      ...
      <div className="flex items-center">
        ...
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-300">Spread the word about your campaign through social media and personal networks.</p>
        </div>
      </div>
      ...
      <div className="flex items-center">
        ...
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-300">Get contributions from people who believe in your cause and watch your project grow.</p>
        </div>
      </div>
      ...
      <div className="flex items-center">
        ...
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-300">With community support, reach your funding goal and make your project a reality.</p>
        </div>
      </div>
    </div>
  </div>
