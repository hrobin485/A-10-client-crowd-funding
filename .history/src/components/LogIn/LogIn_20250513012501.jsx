...
import loginAnimation from "../../assets/login-animation.json"; // ✅ Replace with your animation
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center bg-gray-100 overflow-hidden">
      <div className="absolute inset-0 z-0">
        <Lottie animationData={loginAnimation} loop autoPlay className="w-full h-full object-cover" />
      </div>

      <div className="relative z-10 w-full max-w-md bg-white/80 backdrop-blur-lg p-8 rounded-lg shadow-lg">
