...
const Login = () => {
  ...
  const [redirectTo, setRedirectTo] = useState("/"); // Default redirect route
  ...
  useEffect(() => {
    ...
    // Check if there's a route stored to redirect after login
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      navigate(redirectTo); // Navigate to the previously attempted route or default home
    } catch (error) {
      ...
      <div className="bg-white p-8 rounded shadow-md w-full max-w-md">
        ...
        {!user ? (
          ...
          <div className="flex flex-col items-center">
            ...
            <button
              onClick={() => navigate("/")} // Redirect to home if logged in
