...
const handleLogin = async (e) => {
 ...
 const handleGoogleLogin = async () => {
  ...
  return (
    <div className="my-5 rounded-xl min-h-screen flex flex-col sm:flex-col-reverse md:flex-row items-center justify-center bg-gray-100 overflow-hidden dark:bg-gray-700">
      {/* Left side: Login Box */}
