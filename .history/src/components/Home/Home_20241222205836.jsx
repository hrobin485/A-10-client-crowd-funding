...
const Home = () => {
  ...
  return (
    <div>
      ...
      <div data-aos="fade-down" className=" dark:bg-black dark:text-white">
        <Banner />
      </div>
      ...
      <div data-aos="fade-left" className=" dark:bg-black dark:text-white">
        <HowItWorks />
      </div>

      <div data-aos="fade-up" className=" dark:bg-black dark:text-white">
        <Testimonials />
      </div>
    </div>
  );
