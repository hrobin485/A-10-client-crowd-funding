...
const Home = () => {
  ...
  return (
    <div>
      ...
      <div data-aos="fade-down" className="banner dark:bg-black dark:text-white">
        <Banner />
      </div>

      <div  className="banner  dark:bg-black dark:text-white">
      <RunningCampaign />
      </div>

      <div data-aos="fade-left" className="banner dark:bg-black dark:text-white">
        <HowItWorks />
      </div>

      <div data-aos="fade-up" className="banner dark:bg-black dark:text-white">
        <Testimonials />
      </div>
    </div>
  );
